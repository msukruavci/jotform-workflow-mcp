...
def register(mcp: MCPServer) -> None:
    ...
    def get_step_schema(
        step_type: Annotated[str, Field(
            description='e.g. "workflow_send_email" — get exact names from '
                        "list_step_types."
        )],
    ) -> StepSchema:
        """
        Get the configurable fields for one workflow step type.
        ...
        Positioning fields are omitted — those are handled automatically.
        """
